                    ...
                    <div class="form-fields">
                        ...
                        <div class="form-group">
                            ...
                            <select id="library" name="library">
                                ...
                                <?php
                                $libraries = mysqli_query($con, "SELECT * FROM library");

                                foreach ($libraries as $row) {

                                    // Check if this library matches book's library_id
                                    $selected = ($row['library_id'] == $data['library_id'])
                                        ? "selected"
                                        : "";
                                    echo "<option value='{$row['library_id']}' {$selected}>
                                             {$row['library_name']}
                                          </option>";
                                }
                                ?>
