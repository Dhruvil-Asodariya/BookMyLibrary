...
<body>
    ...
    $library = mysqli_query($con, "SELECT * FROM library WHERE user_id = $user_id");
    $library_data = mysqli_fetch_assoc($library);
    ?>
    ...
    <div class="container">
            ...
            <div class="card" id="viewLibraryProfile">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <p class="p" id="viewLibraryName"><?php echo $library_data['library_name'] ?></p>
                    </div>

                    <div class="form-group">
                        <label>Library Owner Name</label>
                        <p class="p" id="viewLibraryOwnerName"><?php echo $library_data['library_owner_name'] ?></p>
                    </div>

                    <div class="form-group">
                        <label>Library Email</label>
                        <p class="p" id="viewLibraryEmail"><?php echo $library_data['library_email'] ?></p>
                    </div>

                    <div class="form-group">
                        <label>Open At</label>
                        <p class="p" id="viewOpenAt"><?php echo $library_data['open_at'] ?></p>
                    </div>

                    <div class="form-group">
                        <label>Close At</label>
                        <p class="p" id="viewCloseAt"><?php echo $library_data['close_at'] ?></p>
                    </div>
            ...
            <div class="card edit-card" id="editLibraryProfile" style="display:none;">
                ...
                <form method="POST" onsubmit="return validateLibraryForm();">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label>Library Name</label>
                            <input type="text" id="editLibraryName" placeholder="Enter library name" name="library_name">
                            <span id="libraryNameError" class="error"></span>
                        </div>

                        <div class="form-group">
                            <label>Library Owner Name</label>
                            <input type="text" id="editLibraryOwnerName" placeholder="Enter library owner name" name="library_owner_name">
                        ...
                        <div class="form-group">
                            <label>Open At</label>
                            <input type="time" id="editOpenAt" name="open_at">
                            <span id="openAtError" class="error"></span>
                        </div>

                        <div class="form-group">
                            <label>Close At</label>
                            <input type="time" id="editCloseAt" name="close_at">
                            <span id="closeAtError" class="error"></span>
                        </div>

                        <div class="form-group full-width">
                            <label>Library Location</label>
                            <textarea id="editLibraryLocation" rows="3" placeholder="Enter library location" name="library_location"></textarea>
                    ...
                    <div class="edit-actions">
                        ...
                        <button class="save-btn" onclick="saveLibraryEdit()" name="lib_save_btn">Save Changes</button>
                    </div>
                </form>
        ...
        <?php
        if (isset($_POST['lib_save_btn'])) {

            $library_name = $_POST['library_name'];
            $library_owner_name = $_POST['library_owner_name'];
